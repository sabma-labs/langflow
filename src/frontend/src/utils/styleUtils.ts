...
import EndlessIcon from "@/icons/Endless/endless";
import LuffaIcon from "@/icons/Luffa/luffa";
...
export const SIDEBAR_CATEGORIES = [
  ...
  { display_name: "Endless", name: "endless", icon: "Endless" },
  { display_name: "Luffa", name: "luffa", icon: "Luffa" },
