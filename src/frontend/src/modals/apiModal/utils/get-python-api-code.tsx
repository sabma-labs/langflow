...
# API Configuration
try:
    api_key = os.environ["ENDLESS_API_KEY"]
except KeyError:
    raise ValueError("ENDLESS_API_KEY environment variable not found. Please set your API key in the environment variables.")\n`
    : ""
